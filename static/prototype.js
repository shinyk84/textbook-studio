...
const CURRICULUM_DEVELOPMENT_NOTES = {
  "3~4학년군": {
    "운동": {
      changes: [
        "2009 개정 '건강 활동' 대영역(p.12~13)이 '운동' 영역으로 명칭이 바뀌고, 체력·건강이 6개 성취기준(2022 p.16)으로 통합됨.",
        "2009는 '가정의 안전사고 예방', '학교의 안전사고 예방'을 각각 별도 항목으로 명시했으나(p.13), 2022는 '안전하게 활동한다'([4체01-05], p.16)는 태도 수준으로 압축됨.",
      ],
      emphasis: [
        "가정·학교 안전사고 사례를 별도 단원처럼 나열하지 말고, 체력·건강 실천 내용 속 태도로 자연스럽게 녹여 쓸 것([4체01-05], p.16).",
        "체력과 건강을 별개로 설명하지 말고, 운동-체력-건강의 관계([4체01-01][4체01-03], p.16)를 하나의 흐름으로 연결해 서술할 것.",
      ],
    },
    "스포츠": {
      changes: [
        "2009의 '피하기형 경쟁'이라는 범주는 2022의 스포츠 분류 체계(기술형·전략형·생태형)에서 완전히 사라짐(2009 p.14, 2022 p.18~19).",
        "2009 '여가 활동'(전통 놀이와 여가: 스케이팅·자전거·등산, p.15~16)에 속했던 자연 체험형 내용이, 2022에서는 '생태형 스포츠'([4체02-07], p.18~19)로 흡수됨.",
      ],
      emphasis: [
        "축구·농구 같은 특정 구기 종목 규칙부터 설명하지 말고, [4체02-02]~[4체02-04](p.18)의 '기본 움직임 기술' 습득을 먼저 다룰 것.",
        "'생태형 스포츠'(균형 잡고 이동하기·타고 버티기·잡고 오르기 등, p.18~19)는 새 하위유형이므로, 옛 여가 단원 소재를 신체 기능 학습 관점으로 재구성해 쓸 것.",
      ],
    },
    "표현": {
      changes: [
        "2009 3~4학년군 표현 활동은 '움직임 표현'·'리듬 표현' 2개뿐이었으나(p.15), 2022는 모방·추상·리듬·도구 표현 4가지로 세분화됨([4체03-01]~[4체03-07], p.20~21).",
        "2009는 도구 활용을 리듬 표현의 예시(곤봉·공·리본체조, p.16)로만 다뤘지만, 2022는 '도구 표현'을 독립 성취기준([4체03-06], p.20)으로 승격함.",
      ],
      emphasis: [
        "모방 표현(사물·자연 관찰 기반)과 추상 표현(느낌·생각의 자유표현) 예시가 섞이지 않도록 구분해서 집필할 것([4체03-03][4체03-04], p.20~21).",
        "도구 표현([4체03-06], p.20~21)을 다룰 때는 안전한 도구 사용법 안내를 반드시 포함할 것(고려사항, p.21~22).",
      ],
    },
  },
  "5~6학년군": {
    "운동": {
      changes: [
        "2009는 '건강 체력'과 '운동 체력'을 별도 하위영역(p.17~18)으로 나눴으나, 2022 [6체01-01]~[6체01-02](p.23)는 두 체력 유형을 한 성취기준 안에서 함께 이해·측정하도록 통합함.",
        "2022 고려사항(p.24)에 '양성평등 감수성', '인권 보호' 문구가 새로 추가됨 — 2009의 '자기이해'·'상황판단력'(p.17) 서술에는 없던 관점.",
      ],
      emphasis: [
        "체력을 '건강 체력'과 '운동 체력'으로 나눠 별도 단원처럼 쓰지 말고, [6체01-01]~[6체01-02](p.23)처럼 한 흐름에서 비교·측정하도록 구성할 것.",
        "2차 성징·신체 차이를 다룰 때 '양성평등 감수성'·'인권 보호' 관점을 반드시 반영할 것(고려사항, p.24) — 2009식 단순 신체 변화 설명에 그치지 말 것.",
      ],
    },
    "스포츠": {
      changes: [
        "2009는 도전(거리·표적/투기)과 경쟁(필드형·네트형)이 별개 대영역이었으나(p.17~19), 2022는 이를 '기술형·전략형 스포츠'로 통합해 '스포츠' 한 영역에 배치함([6체02-01]~[6체02-06], p.25~26).",
        "2009는 종목마다 '역사 및 과학적 원리' 학습을 명시했으나(p.17~19), 2022 5~6학년군 스포츠 성취기준에는 역사·원리 요소가 빠지고 기능·전략 수행에 집중함.",
      ],
      emphasis: [
        "종목 역사나 과학적 원리 해설에 지면을 쓰지 말고, 기본 기능·전략 수행([6체02-02][6체02-05][6체02-08], p.26~27)에 집중해 쓸 것 — 2009식 역사/원리 서술은 불필요.",
        "'생태형 스포츠' 집필 시 옛 여가 단원 소재(등산·자전거·캠핑 등)를 재활용하되, 여가·취미가 아니라 '기본 기능과 활동방법' 학습 관점으로 재구성할 것([6체02-08][6체02-09], p.27).",
      ],
    },
    "표현": {
      changes: [
        "2009 5~6학년군 표현 활동은 민속표현·주제표현 2개였으나(p.19~20), 2022는 스포츠표현·전통표현·현대표현 3유형으로 재편됨([6체03-01]~[6체03-08], p.29~30).",
        "'스포츠 표현'([6체03-02][6체03-03], p.29)은 2009에 없던 새 하위유형 — 2009 '동작 도전'(p.13~14)의 '아름다운 동작' 개념을 표현 영역으로 옮겨 예술적 표현으로 재정의함.",
      ],
      emphasis: [
        "'스포츠 표현'([6체03-02][6체03-03], p.29)은 완전히 새로운 하위유형이므로, 체조·리듬 등 동작 소재를 '심미적 표현'과 '작품 구성·발표·감상'까지 포함해 다룰 것.",
        "'현대표현'(구 주제표현)은 정형화된 절차보다 '틀에 얽매이지 않는 자유로움'([6체03-06], p.29~30)에 방점을 찍어 서술할 것.",
      ],
    },
  },
};
